...
description := "Truss Modular Scala API Server"

homepage := Some(url("http://www.headstorm.com"))

developers := List(
    Developer(id="CharlesHunt", name="Charles A Hunt",
...
val commonDependencies = Seq(
    ...
    "com.softwaremill.sttp.tapir" %% "tapir-core" % "0.14.2",
...
wartremoverErrors in (Compile, compile) ++= Warts.allBut(Wart.Any, Wart.Nothing, Wart.NonUnitStatements,
    Wart.ImplicitParameter, Wart.ToString)
